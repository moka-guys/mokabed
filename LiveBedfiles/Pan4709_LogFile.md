...
`bedtools subtract -a 'Pan4709_part2data.bed' -b 'Pan4709_part1dataSambamba.bed' >> Pan4709_part1dataSambamba.bed`
`bedtools subtract -a 'Pan4709_part2dataSambamba.bed' -b 'Pan4709_part1dataSambambaSambamba.bed' >> Pan4709_part1dataSambambaSambamba.bed`
...
`cat Pan4761.bed >> Pan4709_part1dataSambambaSambamba.bed `

intronic regions edited manually to match sambamba format in Pan4709_part1dataSambambaSambamba.bed 

## sort bedfiles
#### data.bed
`mv Pan4709_part1dataSambamba.bed Pan4709_part1dataSambamba_unsorted.bed; sort Pan4709_part1dataSambamba_unsorted.bed -k1,1V -k2,2n -k3,3n > Pan4709_part1dataSambamba.bed; rm Pan4709_part1dataSambamba_unsorted.bed`
